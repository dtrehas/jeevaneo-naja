...
public class NajaPackageImpl extends EPackageImpl implements NajaPackage {
	 ...
	 * 
	 * <p>This method is used to initialize {@link NajaPackage#eINSTANCE} when that field is accessed.
	...
	public static NajaPackage init() {
		...
		NajaPackageImpl theNajaPackage = (NajaPackageImpl)(EPackage.Registry.INSTANCE.get(eNS_URI) instanceof NajaPackageImpl ? EPackage.Registry.INSTANCE.get(eNS_URI) : new NajaPackageImpl());
		...
		EPackage.Registry.INSTANCE.put(NajaPackage.eNS_URI, theNajaPackage);
