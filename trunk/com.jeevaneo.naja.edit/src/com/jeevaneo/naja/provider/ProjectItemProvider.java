...
/**
 * This is the item provider adapter for a {@link com.jeevaneo.naja.Project} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ProjectItemProvider
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 NajaPackage.Literals.PROJECT__NAME,
				 true,
				 false,
				 false,
	...
	protected void addTotalLoadPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Project_totalLoad_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Project_totalLoad_feature", "_UI_Project_type"),
				 NajaPackage.Literals.PROJECT__TOTAL_LOAD,
				 false,
				 false,
				 false,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(NajaPackage.Literals.PROJECT__PLANIFICATIONS);
			childrenFeatures.add(NajaPackage.Literals.PROJECT__RESOURCES);
			childrenFeatures.add(NajaPackage.Literals.PROJECT__IMPUTATIONS);
			childrenFeatures.add(NajaPackage.Literals.PROJECT__CATEGORIES);
			childrenFeatures.add(NajaPackage.Literals.PROJECT__TASKS);
		}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(NajaPackage.Literals.PROJECT__PLANIFICATIONS,
				 NajaFactory.eINSTANCE.createPlanification()));

		newChildDescriptors.add
			(createChildParameter
				(NajaPackage.Literals.PROJECT__RESOURCES,
				 NajaFactory.eINSTANCE.createPerson()));

		newChildDescriptors.add
			(createChildParameter
				(NajaPackage.Literals.PROJECT__IMPUTATIONS,
				 NajaFactory.eINSTANCE.createImputation()));

		newChildDescriptors.add
			(createChildParameter
				(NajaPackage.Literals.PROJECT__CATEGORIES,
				 NajaFactory.eINSTANCE.createCategory()));

		newChildDescriptors.add
			(createChildParameter
				(NajaPackage.Literals.PROJECT__TASKS,
