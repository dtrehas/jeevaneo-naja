...
/**
 * This is the item provider adapter for a {@link com.jeevaneo.naja.Schedule} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ScheduleItemProvider
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Schedule_date_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Schedule_date_feature", "_UI_Schedule_type"),
				 NajaPackage.Literals.SCHEDULE__DATE,
				 true,
				 false,
				 false,
	...
	protected void addLoadPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Schedule_load_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Schedule_load_feature", "_UI_Schedule_type"),
				 NajaPackage.Literals.SCHEDULE__LOAD,
				 true,
				 false,
				 false,
	...
	protected void addLabelPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Schedule_label_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Schedule_label_feature", "_UI_Schedule_type"),
				 NajaPackage.Literals.SCHEDULE__LABEL,
				 false,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	public String getText(Object object) {
		Date labelValue = ((Schedule)object).getDate();
