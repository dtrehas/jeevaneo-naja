...
/**
 * <!-- begin-user-doc -->
 * A sample utility for the '<em><b>naja</b></em>' package.
 * <!-- end-user-doc -->
 * @generated
 */
public class NajaExample {
	/**
	 * <!-- begin-user-doc -->
	...
	public static void main(String[] args) {
		...
		if (args.length == 0) {
			...
			try {
				Resource resource = resourceSet.createResource(URI.createURI("http:///My.naja"));
				Person root = NajaFactory.eINSTANCE.createPerson();
