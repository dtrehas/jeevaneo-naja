 ...
 * <li>{@link com.jeevaneo.naja.timeentries.impl.TimeEntryImpl#getImputations
 * <em>Imputations</em>}</li>
 * </ul>
 * </p>
 * 
 * @generated
...
public class TimeEntryImpl extends EObjectImpl implements TimeEntry {
	...
	void recomputeImputation() {
		...
		if (!getImputations().isEmpty()) {
			imputation = getImputations().get(0);
		}
		...
		eUnset(TimeentriesPackage.TIME_ENTRY__IMPUTATIONS);
		// setImputation(null);
	...
	public EList<Imputation> getImputations() {
		if (imputations == null) {
			imputations = new EObjectContainmentEList<Imputation>(
					Imputation.class, this,
					TimeentriesPackage.TIME_ENTRY__IMPUTATIONS);
		}
		return imputations;
	}
