...
/**
 * This is the item provider adapter for a {@link com.jeevaneo.naja.timeentries.TimeEntry} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class TimeEntryItemProvider
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_TimeEntry_comment_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_TimeEntry_comment_feature", "_UI_TimeEntry_type"),
				 TimeentriesPackage.Literals.TIME_ENTRY__COMMENT,
				 true,
				 false,
				 false,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 TimeentriesPackage.Literals.TIME_ENTRY__DAY,
				 true,
				 false,
				 false,
	...
	protected void addLoadPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_TimeEntry_load_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_TimeEntry_load_feature", "_UI_TimeEntry_type"),
				 TimeentriesPackage.Literals.TIME_ENTRY__LOAD,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.INTEGRAL_VALUE_IMAGE,
	...
	protected void addResourcePropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_TimeEntry_resource_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_TimeEntry_resource_feature", "_UI_TimeEntry_type"),
				 TimeentriesPackage.Literals.TIME_ENTRY__RESOURCE,
				 true,
				 false,
				 true,
				 null,
	...
	protected void addExternalIdPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_TimeEntry_externalId_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_TimeEntry_externalId_feature", "_UI_TimeEntry_type"),
				 TimeentriesPackage.Literals.TIME_ENTRY__EXTERNAL_ID,
				 true,
				 false,
				 false,
				 null,
	...
	public String getText(Object object) {
		String label = ((TimeEntry)object).getComment();
	...
	public ResourceLocator getResourceLocator() {
		return NajaTimeEntriesEditPlugin.INSTANCE;
	}
