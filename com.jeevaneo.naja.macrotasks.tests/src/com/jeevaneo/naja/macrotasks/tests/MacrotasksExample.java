...
/**
 * <!-- begin-user-doc -->
 * A sample utility for the '<em><b>macrotasks</b></em>' package.
 * <!-- end-user-doc -->
 * @generated
 */
public class MacrotasksExample {
	/**
	 * <!-- begin-user-doc -->
	...
	public static void main(String[] args) {
		...
		resourceSet.getPackageRegistry().put
			(MacrotasksPackage.eNS_URI, 
			 MacrotasksPackage.eINSTANCE);
		...
		if (args.length == 0) {
			...
			try {
				Resource resource = resourceSet.createResource(URI.createURI("http:///My.macrotasks"));
				Macrotask root = MacrotasksFactory.eINSTANCE.createMacrotask();
