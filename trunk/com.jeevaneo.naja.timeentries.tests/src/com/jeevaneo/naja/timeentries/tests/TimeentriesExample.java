...
/**
 * <!-- begin-user-doc -->
 * A sample utility for the '<em><b>timeentries</b></em>' package.
 * <!-- end-user-doc -->
 * @generated
 */
public class TimeentriesExample {
	...
	public static void main(String[] args) {
		...
		resourceSet.getPackageRegistry().put
			(TimeentriesPackage.eNS_URI, 
			 TimeentriesPackage.eINSTANCE);
		...
		if (args.length == 0) {
			...
			try {
				Resource resource = resourceSet.createResource(URI.createURI("http:///My.timeentries"));
				TimeEntries root = TimeentriesFactory.eINSTANCE.createTimeEntries();
