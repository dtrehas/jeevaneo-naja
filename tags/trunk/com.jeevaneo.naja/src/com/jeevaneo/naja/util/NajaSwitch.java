...
public class NajaSwitch<T> {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case NajaPackage.PERSON: {
				Person person = (Person)theEObject;
				T result = casePerson(person);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case NajaPackage.TASK: {
				Task task = (Task)theEObject;
				T result = caseTask(task);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case NajaPackage.IMPUTATION: {
				Imputation imputation = (Imputation)theEObject;
				T result = caseImputation(imputation);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case NajaPackage.PLANIFICATION: {
				Planification planification = (Planification)theEObject;
				T result = casePlanification(planification);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case NajaPackage.PROJECT: {
				Project project = (Project)theEObject;
				T result = caseProject(project);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case NajaPackage.CATEGORY: {
				Category category = (Category)theEObject;
				T result = caseCategory(category);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case NajaPackage.SCHEDULE: {
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>Planification</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>Planification</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T casePlanification(Planification object) {
		return null;
	}
