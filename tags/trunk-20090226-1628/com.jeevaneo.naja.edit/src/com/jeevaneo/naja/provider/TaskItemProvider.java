...
/**
 * This is the item provider adapter for a {@link com.jeevaneo.naja.Task} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Task_totalLoad_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Task_totalLoad_feature", "_UI_Task_type"),
				 NajaPackage.Literals.TASK__TOTAL_LOAD,
				 true,
				 false,
				 false,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 NajaPackage.Literals.TASK__NAME,
				 true,
				 false,
				 false,
	...
	protected void addImputationsPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Task_imputations_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Task_imputations_feature", "_UI_Task_type"),
				 NajaPackage.Literals.TASK__IMPUTATIONS,
				 true,
				 false,
				 true,
				 null,
	...
	protected void addPlanificationsPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Task_planifications_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Task_planifications_feature", "_UI_Task_type"),
				 NajaPackage.Literals.TASK__PLANIFICATIONS,
				 true,
				 false,
				 true,
				 null,
	...
	protected void addUnaffectedLoadPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Task_unaffectedLoad_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Task_unaffectedLoad_feature", "_UI_Task_type"),
				 NajaPackage.Literals.TASK__UNAFFECTED_LOAD,
				 false,
				 false,
				 false,
				 ItemPropertyDescriptor.INTEGRAL_VALUE_IMAGE,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 NajaPackage.Literals.TASK__PRIORITY,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.INTEGRAL_VALUE_IMAGE,
	...
	protected void addLabelPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Task_label_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Task_label_feature", "_UI_Task_type"),
				 NajaPackage.Literals.TASK__LABEL,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
